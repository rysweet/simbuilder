...
from .client import AzureOpenAIClient, ChatMessage
from .exceptions import LLMError, PromptRenderError
from .prompts import render_prompt, list_prompts
...
def chat_command(
    ...
    model: Optional[str] = typer.Option(None, "--model", help="Model to use (overrides config)"),
...
async def _create_embeddings(text: str, model: Optional[str], output_format: str) -> None:
